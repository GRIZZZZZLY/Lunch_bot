    ...
    try {
      ...
      if (menuResponse.success && menuResponse.data) {
        ...
        const takeawayOption: MenuItem = {
          id: -1, // Специальный ID для "Еда с собой"
          name: 'Еда с собой',
        ...
        console.log('📝 Adding takeaway option to menu items:', {
          beforeCount: items.length,
          afterCount: items.length + 1,
          takeawayOption
        });
        ...
        console.log('✅ Menu items updated (with takeaway option):', updatedItems.map(i => i.name));
      }
          ...
          {menuItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm max-w-xs">
                Администратор еще не выбрал блюда для этого голосования. Подождите немного!
              </p>
            </div>
          ) : (
