...
import { LunchDnaCard } from '../components/stats/LunchDnaCard';

// Budget components
import { BudgetWidgetCompact } from '../components/budget/BudgetWidgetCompact';
      ...
      <div className="space-y-4 pb-24 px-4 pt-4">
        ...
        >
          ...
          >
            ...
            {/* Tab: Моё (Personal) */}
            <StatsPersonalTab controller={controller} />

            {/* Tab: Группа (Group) - объединенный контент */}
            <StatsGroupTab controller={controller} />

            {/* Tab: Глобально (Global) - старый контент Polls + Menu */}
            <StatsGlobalTab controller={controller} />

            {/* Tab: Инсайты (Insights) - Sprint 5 */}
            <StatsInsightsTab controller={controller} />
          </Tabs>
        </m.div>
      </div>
    </>
