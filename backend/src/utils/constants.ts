...
export const BOT_CONSTANTS = {
  ...
  // Лимиты
  LIMITS: {
    MAX_POLL_DURATION: 120, // минут
    MIN_POLL_DURATION: 1,   // минут
    MAX_MENU_ITEMS: 20,     // максимум блюд в одном голосовании
    MIN_MENU_ITEMS: 2,      // минимум блюд для голосования
  ...
  DEFAULTS: {
    POLL_DURATION: 30,      // минут
    PAGE_SIZE: 10,          // элементов на страницу
    AUTO_ROULETTE: true,    // автоматический запуск рулетки
    NOTIFICATION_DELAY: 5,  // минут до уведомления
  },
