...
export function mockRequest(init: MockRequestInit = {}): Request {
...
export function memberRequest(init: MockRequestInit = {}): Request {
  return mockRequest({ user: { id: 1, isAdmin: false }, ...init });
}

/** Аутентифицированный глобальный админ. */
export function adminRequest(init: MockRequestInit = {}): Request {
