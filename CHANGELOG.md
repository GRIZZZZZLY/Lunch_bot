...
- Удалены устаревшие планы, отчёты о завершённых работах и дублирующие
  инструкции 2025 года.
- `README.md`, инструкции для агентов, запуск, тестирование, API, выпуск и
  резервное копирование приведены к текущей структуре с `main` и
  `frontend-new`.
