...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-07 (commit c2703370). Confidence: 96%.
...
### Code health
Three co-equal signals: defect risk 7.74/10 avg, hotspot health 4.64/10 (stable), worst `backend/src/api/controllers/category-order.controller.ts` at 1.9/10 · maintainability 8.77/10 · performance risk 39 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `backend/src/services/store-run.service.ts` — change entropy — impact −2.1
