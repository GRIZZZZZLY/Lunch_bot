...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-06 (commit 726538bc). Confidence: 96%.
...
- `frontend-new/src/features/home/HomePage.tsx` — 6 bug fixes, last fix today (bug magnet); 13 commits/90d
...
### Code health
Three co-equal signals: defect risk 7.82/10 avg, hotspot health 4.59/10 (stable), worst `backend/src/api/controllers/auth.controller.ts` at 1.9/10 · maintainability 8.77/10 · performance risk 39 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `backend/src/services/category-order.service.ts` — complex conditional (updateCosts) — impact −2.2
- `backend/src/api/controllers/auth.controller.ts` — function hotspot (validateInitData) — impact −2.2
- `backend/src/services/__tests__/poll.service.test.ts` — change entropy — impact −2.1
- `backend/src/services/group.service.ts` — change entropy — impact −2.1
- `frontend-new/src/components/rl/Icon.tsx` — untested hotspot — impact −2.0
