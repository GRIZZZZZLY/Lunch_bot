...
const ICON_PATHS = {
  ...
  /* Логотип бренда: корпус ракеты со стабилизаторами и выхлоп из трёх
     зубцов-языков — читается и как пламя, и как вилка.
     Пламя ЗАЛИТО, а не обведено, и это не стилистика: контурные зубцы на
     32px тайле слипаются (зазор 2.4 ед. меньше обводки) и превращаются в
     комок «лапок». Заливка держит форму вплоть до 20px.
     Все три языка зеркальны относительно x=12. */
  rocket: (
    <>
      <path d="M12 2.5c2.4 2.5 3.6 5.5 3.6 8.6v2.9H8.4v-2.9c0-3.1 1.2-6.1 3.6-8.6z" />
      <circle cx="12" cy="8.8" r="1.4" />
      <path d="M8.4 11.5 6.1 13.8v2.7l2.3-1.8M15.6 11.5 17.9 13.8v2.7l-2.3-1.8" />
      <path
        fill="currentColor"
        stroke="none"
        d="M12 14.9c1.05 1.9 1.3 3.3.85 4.5-.3.8-.85 1.7-.85 2.5 0-.8-.55-1.7-.85-2.5-.45-1.2-.2-2.6.85-4.5z"
      />
      <path
        fill="currentColor"
        stroke="none"
        d="M9.75 14.9c.75 1.4.9 2.4.6 3.3-.2.6-.6 1.2-.6 1.8 0-.6-.4-1.2-.6-1.8-.3-.9-.15-1.9.6-3.3z"
      />
      <path
        fill="currentColor"
        stroke="none"
        d="M14.25 14.9c.75 1.4.9 2.4.6 3.3-.2.6-.6 1.2-.6 1.8 0-.6-.4-1.2-.6-1.8-.3-.9-.15-1.9.6-3.3z"
      />
    </>
  ),
  calendar: (
