...
export function LunchDnaCard({ profile, isDark }: LunchDnaCardProps) {
  ...
  return (
    ...
    >
      <PastelCard
        variant='default'
        className={cn(
          'overflow-hidden border-border/70 shadow-[0_14px_34px_rgba(33,24,13,0.06)]',
          isDark
            ? 'bg-[linear-gradient(145deg,rgba(31,30,43,0.98),rgba(18,18,27,0.98))]'
            ...
            >
              <svg viewBox='0 0 220 220' className='h-[190px] w-[190px]'>
                ...
                <polygon
                  ...
                  fill={isDark ? 'rgba(167,139,250,0.20)' : 'rgba(216,106,44,0.16)'}
                  stroke={isDark ? 'rgba(167,139,250,0.95)' : 'rgba(216,106,44,0.92)'}
                  strokeWidth='2.5'
                />
                <circle
                  cx='110'
                  cy='110'
                  r='4'
                  fill={isDark ? 'rgba(167,139,250,1)' : 'rgba(216,106,44,1)'}
                />
              </svg>
            </div>
              ...
              {profile.axes.map(axis => (
                ...
                >
                  ...
                  <div className='h-2 overflow-hidden rounded-full bg-muted/50'>
                    <div
                      className={cn('h-full rounded-full', isDark ? 'bg-lavender-400' : 'bg-primary')}
