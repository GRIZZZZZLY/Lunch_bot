...
Старые релизы скрипт не удаляет: их чистит шаг `Prune old releases` рабочего
процесса. Каждый релиз несёт свои `node_modules`, поэтому за местом на диске
следите после серии ручных выпусков.
