...
const EMPTY_STATE_CONFIGS: Record<EmptyStateType, EmptyStateConfig> = {
  'no-polls': {
    ...
    description: 'Создай первое голосование и начни выбирать обед вместе с командой!',
  ...
  'no-menu': {
    ...
    description: 'Добавь первые блюда, чтобы начать голосования',
  ...
  'no-votes': {
    ...
    description: 'Будь первым! Твой голос важен для команды',
  ...
  'no-stats': {
    ...
    description: 'Проведи несколько голосований, чтобы увидеть аналитику',
  ...
  'no-history': {
    icon: ScrollText,
    title: 'История пуста',
    description: 'Здесь будут отображаться твои прошлые голосования',
  ...
  'no-favorites': {
    ...
    description: 'Добавь любимые блюда, чтобы быстро найти их позже',
  ...
  'no-results': {
    ...
    description: 'Попробуй изменить параметры поиска или фильтры',
  ...
  'no-suggestions': {
    ...
    description: 'Предложи новое блюдо для меню! Твоя идея может стать хитом',
  ...
  'poll-completed': {
    ...
    description: 'Результаты уже подведены. Посмотри, что выбрала команда!',
