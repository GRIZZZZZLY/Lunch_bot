...
const tutorialSteps: TutorialStep[] = [
  {
    icon: '🗳️',
    title: 'Добро пожаловать в голосование!',
    description: 'Сейчас мы покажем, как быстро проголосовать за любимое блюдо',
  },
  {
    icon: '👆',
    title: 'Выберите блюдо',
    description: 'Нажмите на карточку блюда, которое вам нравится. Можно выбрать только одно блюдо.',
  },
  {
    icon: '✨',
    title: 'Получите обратную связь',
    description: 'После выбора блюдо подсветится, и вы почувствуете вибрацию (haptic feedback)',
  },
  {
    icon: '🚀',
    title: 'Подтвердите выбор',
    description: 'Нажмите кнопку "Проголосовать" внизу экрана или используйте кнопку Telegram',
  },
  {
    icon: '🎉',
    title: 'Готово!',
    description: 'Ваш голос учтён! Вы можете изменить выбор в любое время до завершения голосования.',
  },
];
