...
import { PerformanceMonitor } from './components/performance/WebVitals';
...
const StoreRunPage = createLazyComponent(
  () => import("./pages/StoreRunPage"),
  "StoreRunPage",
);

const MenuPage = createLazyComponent(
  () => import("./pages/MenuPage"),
  "MenuPage",
);
// VotingPage УДАЛЁН - функционал перенесён в InlineVotingCard на главной странице
const PollHistoryPage = createLazyComponent(
  () => import("./pages/PollHistoryPage"),
  "PollHistoryPage",
);
const PollResultsPage = createLazyComponent(
  () => import("./pages/PollResultsPage"),
  "PollResultsPage",
);
...
const SuggestionsPage = createLazyComponent(
  () => import("./pages/SuggestionsPage"),
  "SuggestionsPage",
);
const MySuggestionsPage = createLazyComponent(
  () => import("./pages/MySuggestionsPage"),
  "MySuggestionsPage",
);
const UserStatsPage = createLazyComponent(
  () => import("./pages/UserStatsPage"),
  "UserStatsPage",
);
...
function AppContent() {
  ...
  const showNavigation = ["/", "/menu", "/stats", "/profile", "/vote"].includes(
    location.pathname,
  );
        ...
        <div className="flex-1">
          <Suspense fallback={<AppSkeleton />}>
            <Routes>
              ...
              <Route path="/vote/hub" element={<HomePage />} />{" "}
              {/* Legacy redirect */}
