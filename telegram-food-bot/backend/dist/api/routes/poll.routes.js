...
router.get('/stats', telegram_auth_1.telegramAuthMiddleware, rate_limiter_1.heavyOperationLimiter, poll_controller_1.pollController.getPollStats);
...
router.post('/', telegram_auth_1.telegramAuthMiddleware, telegram_auth_1.adminMiddleware, rate_limiter_1.pollCreationLimiter, poll_controller_1.pollController.createPoll);
router.post('/create-from-webapp', telegram_auth_1.telegramAuthMiddleware, telegram_auth_1.adminMiddleware, rate_limiter_1.pollCreationLimiter, poll_controller_1.pollController.createPollFromWebApp);
...
router.post('/:id/vote', telegram_auth_1.telegramAuthMiddleware, rate_limiter_1.voteLimiter, poll_controller_1.pollController.vote);
router.post('/:id/vote-multiple', telegram_auth_1.telegramAuthMiddleware, rate_limiter_1.voteLimiter, poll_controller_1.pollController.voteMultiple);
