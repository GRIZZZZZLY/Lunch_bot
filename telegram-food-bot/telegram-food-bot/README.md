...
- 🎯 **Персонализированный UX** с системой быстрых действий (Повторить, Рулетка)
- ⭐ **Vote Rating System** для улучшения рекомендаций блюд
- 🎲 **Рулетка выбора** для случайного подбора блюда
- 🤝 **Invite система** с deep linking в Telegram
